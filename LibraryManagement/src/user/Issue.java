...
public class Issue {
    ...
    public DefaultTableModel searchIssue(int id, int bookID, int readerID) {
        try {
    ...
    public DefaultTableModel getAllIssues() {
        try {
            PreparedStatement ps;
            ResultSet rs;
    ...
    public boolean addIssue(int bookID, int readerID, String checkoutDate) {
    ...
    public boolean updateIssue(int id, int bookID, int readerID, String checkoutDate, String returnDate) throws ParseException {
        if (!book.isAvailablel(bookID)) {
