...
public class Reader {
    ...
    public DefaultTableModel searchReader(int id, String fname, String lname) {
        try {
    ...
    public boolean addReader(String fname, String lname) {
        try {
            PreparedStatement ps;
    ...
    public boolean updateReader(int id, String fname, String lname) {
        try {
            PreparedStatement ps;
