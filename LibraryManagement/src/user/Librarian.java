...
public class Librarian {
    ...
    public DefaultTableModel searchLibrarian(int id, String fname, String lname, String username) {
        try {
    ...
    public DefaultTableModel getAllLibrarians() {
        try {
            PreparedStatement ps;
            ResultSet rs;
    ...
    public boolean addLibrarian(String fname, String lname, String username, String password) {
        try {
            PreparedStatement ps;
    ...
    public boolean deleteLibrarianByUsername(String username) {
        try {
            PreparedStatement ps;
    ...
    public boolean updateLibrarianByID(int id, String fname, String lname, String username, String password) {
        try {
            PreparedStatement ps;
